...
for modifier_prompt in grubhub_menu["modifier_prompts"]:
...
for item in grubhub_menu["items"]:
    ...
    for modifier_prompt_uuid in item["modifier_prompts"]:
        modifier_list_uuid = menu["modifier_prompts"][modifier_prompt_uuid][
            "latest_version"
        ]["modifier_list"]
        for modifier_uuid in menu["modifier_lists"][modifier_list_uuid][
            "latest_version"
        ]["modifiers"]:
